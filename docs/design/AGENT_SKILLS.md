...
struct SkillDefinition: Identifiable {
    ...
    let description: String       // 概要説明（例：「コードの品質をレビューする」）
...
│ provider        │       │ assignedAt           │       │ description     │
│ system_prompt   │       └──────────────────────┘       │ directoryName   │
└─────────────────┘                                      │ content         │
                                                         │ createdAt       │
                                                         │ updatedAt       │
                                                         └─────────────────┘
...
| 2026-01-29 | 実装計画セクションを `docs/plan/AGENT_SKILLS_IMPLEMENTATION.md` に分離 |
| 2026-01-29 | `description` フィールド追加: 人間向けの概要説明 |
